...
def render_notes(tag: str, workflow_url: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "```",
            "",
            "After the session, `tools/finalize_playtest_session.py create` can pair the observer sheet with the matching local feedback export in a create-only, checksummed packet.",
            "",
