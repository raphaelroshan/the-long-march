...
run_checked "PASS: The Long March LM-GPT56-1B completion evidence contract" env LONG_MARCH_GPT56_1_PROFILE=1 "$GODOT_BIN" --headless --path . --script res://tests/test_complete_journey_handoff.gd
