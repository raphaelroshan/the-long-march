...
| Packaging | Windows/macOS/Linux export, native launch smoke, checksum manifest, cohort preflight, rollback identity | Owner downloads all three artifacts, verifies them independently, and approves promotion. |
