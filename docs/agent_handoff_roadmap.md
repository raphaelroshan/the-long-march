...
**Current code baseline:** `0.3.0-alpha.299`
...
**Current merged baseline:** `0.3.0-alpha.299`, preserving the complete journey while carrying threat, target, impact, dependency loss, arrival priority, and recovery action through one readable causal chain.
