...
**Current code baseline:** `0.3.0-alpha.343`
...
**Current merged baseline:** `0.3.0-alpha.343`, preserving the complete causal journey and private-alpha evidence workflow while giving the public repository a concise player-first landing page. The README now leads with the fortress premise, playable release, current loop, two-chapter slice, controls, honest scope boundary, and direct design/testing references instead of an implementation inventory.
...
**Evidence support:** `0.3.0-alpha.343` makes the public entry point match the actual playable slice, `0.3.0-alpha.342` gives testers usable instructions on the release itself, and the verified cohort tools establish artifact and state identity without inferring comprehension.
