...
**Current code baseline:** `0.3.0-alpha.308`
...
**Current merged baseline:** `0.3.0-alpha.308`, preserving the complete causal journey while carrying the same fortress actor from the prologue into play and giving each implemented threat family a distinct approach warning.
