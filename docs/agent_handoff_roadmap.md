...
| Packaging | Local and CI verification includes five bounded timed groups, Godot coverage on Ubuntu and Windows, policy/content checks, Windows/macOS/Linux export scripts, packaged smoke coverage, offline boundaries, input, scaling, pause, save path, and teardown checks. |
