...
**Current code baseline:** `0.3.0-alpha.348`
...
**Current merged baseline:** `0.3.0-alpha.348`, preserving the complete causal journey while making both published platform cohorts prove observer preflight, packet creation, packet verification, and cohort synthesis before release.
...
**Evidence support:** `0.3.0-alpha.348` runs the complete bundled evidence workflow against both downloaded release cohorts, `0.3.0-alpha.347` adds current compact-screen visual evidence and collision assertions, and the cohort tools establish artifact and state identity without inferring comprehension.
