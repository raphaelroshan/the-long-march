...
**Current code baseline:** `0.3.0-alpha.345`
...
**Current merged baseline:** `0.3.0-alpha.345`, preserving the complete causal journey and private-alpha evidence workflow while adding provenance-checked session packets. One create-only command binds exact observer notes and the matching in-game export to the verified cohort, generates a separate automatic summary, and checksums the packet without claiming consent or comprehension.
...
**Evidence support:** `0.3.0-alpha.345` binds each observer sheet to its matching export in a locally verifiable packet, `0.3.0-alpha.344` protects human-authored evidence from replacement, and the verified cohort tools establish artifact and state identity without inferring comprehension.
