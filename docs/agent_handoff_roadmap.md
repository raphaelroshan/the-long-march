...
**Current code baseline:** `0.3.0-alpha.304`
...
**Current merged baseline:** `0.3.0-alpha.304`, preserving the complete causal journey while making the resting fortress visibly inhabited and serviceable.
