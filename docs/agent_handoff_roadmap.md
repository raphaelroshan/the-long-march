...
**Current code baseline:** `0.3.0-alpha.307`
...
**Current merged baseline:** `0.3.0-alpha.307`, preserving the complete causal journey while carrying the same fortress actor from the prologue into play.
