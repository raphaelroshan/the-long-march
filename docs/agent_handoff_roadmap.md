...
**Current code baseline:** `0.3.0-alpha.305`
...
**Current merged baseline:** `0.3.0-alpha.305`, preserving the complete causal journey while making map position, route state, and assignment relevance readable without color alone.
