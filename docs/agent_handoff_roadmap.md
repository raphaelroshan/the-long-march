...
**Current code baseline:** `0.3.0-alpha.306`
...
**Current merged baseline:** `0.3.0-alpha.306`, preserving the complete causal journey while giving every implemented roadside occurrence a decision-specific physical tableau.
