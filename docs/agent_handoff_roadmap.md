...
**Current code baseline:** `0.3.0-alpha.298`
...
**Current merged baseline:** `0.3.0-alpha.298`, adding clearer fortress state, travel rhythm, threat targeting, settlement atmosphere, roadside framing, route commitment hierarchy, and Debrief causality on top of the alpha.297 private-alpha hardening gate.
