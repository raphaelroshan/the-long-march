...
38. At 110% text, confirm the title reads **Two Playable Regions · Playtest Build · v&lt;version&gt;** and Pause reads **Playtest Build · v&lt;version&gt;**. Both must show the exact same application version without the duplicated `ALPHA · v...alpha...` wording or clipping.
