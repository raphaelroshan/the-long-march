...
The verified prerelease is [`v0.3.0-alpha.297`](https://github.com/raphaelroshan/the-long-march/releases/tag/v0.3.0-alpha.297). Both platform cohort archives share source revision `0898788fb86ebbf6a720955b33a9ed6f8483a2e2` and passed packaged launch smoke before upload.
